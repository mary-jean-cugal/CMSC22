...
public class RPG {
    ...
    public Fighter generateHero(){
        ...
        Fighter hero = new Fighter(name,weaponDamage[randInt(0,4)],energy[randInt(0,4)]);
        return hero;
    }
    ...
    public Pet generatePet(Fighter hero){
        Pet pet;
